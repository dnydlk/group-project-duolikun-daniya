                    ...
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        if (user != null && user.getGroups() != null && !user.getGroups().isEmpty()) {
                            ...
                            if (user.getGroups().size() == 1) {
                                ...
                                testTextView.setText("User is part of one group, present with that group");
                                Log.d("GroupCount", "User is part of one group");
                            } else {
                                // User is part of more than one groups, proceed with the last interacted group
                                // todo Show the last interacted group here
                                testTextView.setText("User is part of more than one groups, proceed with the last interacted group");
                            }
